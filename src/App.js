...
function App(props) {
  ...
  useEffect(()=>{
    ...
    Axios.get('https://appointment-backend-new-1.herokuapp.com/pending').then((res)=>{
    ...
    <form className="d-flex">
      ...
      <div className="list-group">
        {request1_list.map((val,key)=>{
          return(
            <div className="list-group-item list-group-item-action list-group-item-danger" >Name : {val.userName}   Email : {val.email} Reason : {val.reason} Time : {val.time} <a href="https://atharvabokade.github.io/email-accept/"><button type="submit" id ="btn_req" onClick={()=>approve(val._id)} className="btn btn-success btn-sm">Approve</button></a>
